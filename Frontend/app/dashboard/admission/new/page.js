...
export default function ApplicationForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Build a clean payload excluding files
      const {
        avatar,
        aadharCard,
        previousSchoolTC,
      ...
      await API.post("/students", payload); // No need to set Content-Type; Axios will use application/json
          ...
          <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
            <div className="p-6">
              <div className="flex flex-col sm:flex-row gap-4 justify-end">
                ...
                <button
                  type="submit"
                  className="px-8 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-medium rounded-lg hover:from-blue-700 hover:to-indigo-700 transform hover:scale-105 transition-all duration-200 shadow-lg"
                >
                  Submit Application
                </button>
              </div>
