        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 xl:grid-cols-4 gap-4">
          {sessions.map((session) => (
            ...
            >
              ...
              <div
                className={`inline-flex items-center text-xs px-4 py-1 rounded-full font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 border ${
                  session.isActive
